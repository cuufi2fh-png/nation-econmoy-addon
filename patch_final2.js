...
let interactionIndex = code.indexOf('// ====== V0.3, V0.4, V0.5: 상호작용 (깃대, 은행 NPC) ======');
if (interactionIndex === -1) {
    console.error("Interaction index not found!");
    process.exit(1);
}
let interactionPart = code.substring(interactionIndex);
